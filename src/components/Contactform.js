    ...
    return (
        <div>
            ...
            <form onSubmit={addnewcontact}>
                <TextField  variant="outlined" lable="Name" fullWidth type="text"  required value={name} placeholder="addname" onChange={ChangehandlerName}/>
                <TextField  variant="inlined"  fullWidth lable="Phone-no" type="text" required value={number} placeholder="add Number" onChange={ChangehandlerNumber}/>
